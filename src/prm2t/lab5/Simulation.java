...
public class Simulation<T extends Individual> {
    ...
    public static void main(String... args) {
        ...
        simulations.add(new Simulation<>(nEach, IndividualRandomThenRepeat::new));
        simulations.add(new Simulation<>(nEach, IndividualCooperateThenDefectIfTwice::new));
        simulations.add(new Simulation<>(nEach, IndividualRandomThenMost::new));
